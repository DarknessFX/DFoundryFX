...
ECHO.
ECHO %_fGreen%%_bBlack%Moving ImGui_Debug.lib to binaries.%_ResetColor%
MOVE /Y Binaries\Debug\ImGui.lib Binaries\ImGui_Debug.lib
MOVE /Y Binaries\Debug\ImGui.pdb Binaries\ImGui_Debug.pdb
RMDIR Binaries\Debug
IF %ERRORLEVEL% NEQ 0 ( GOTO :ERROR )
...
ECHO.
ECHO %_fGreen%%_bBlack%Moving ImGui Release to binaries.%_ResetColor%
MOVE /Y Binaries\Release\ImGui.lib Binaries\ImGui.lib
RMDIR Binaries\Release
IF %ERRORLEVEL% NEQ 0 ( GOTO :ERROR )
...
MOVE /Y Binaries\ImGui_Debug*.* ..\..\..\Binaries\Win64\
MOVE /Y Binaries\ImGui*.* ..\..\..\Binaries\Win64\
IF %ERRORLEVEL% NEQ 0 ( GOTO :ERROR )
